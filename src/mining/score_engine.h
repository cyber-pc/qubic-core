...
// This file contain core mining/score computation only.
// Try to stay alone as posible so that it can be easier to porting to multiple platform
...
struct ScoreEngine
{
    ...
    void getLastOutput(unsigned char* result, unsigned long long sizeInBytes)
    {
