...
#define NUMBER_OF_SOLUTION_PROCESSORS 1 // do not increase this, because there may be issues due to too fast ticking
...
#define MAX_NUMBER_OF_TICKS_PER_EPOCH (((((60 * 60 * 1 * 1) / (TARGET_TICK_DURATION / 1000)) + NUMBER_OF_COMPUTORS - 1) / NUMBER_OF_COMPUTORS) * NUMBER_OF_COMPUTORS)
